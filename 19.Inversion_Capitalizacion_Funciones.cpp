...
double tasa_interes_periodo(double I, int P){
    return I / P;
}

int periodos_capitalizables(int P, int n2){
    return P * n2;
}

double inversion_final(double c, double i2, int N){
    return c * pow((1 + i2), N);
}
        ...
        if (c > 0) {
            ...
            if (n2 > 0) {
                ...
                if (P != 0) {
                    ...
                    cout << "Tasa de interes por periodo: " << tasa_interes_periodo(I, P) << endl;
                    cout << "Años: " << n2 << endl;
                    cout << "Numero de periodos capitalizables por año: " << P << endl;
                    cout << "Total de periodos capitalizables: " << periodos_capitalizables(P, n2) << endl;
                    cout << "Valor final de la inversion: $" << inversion_final(c, tasa_interes_periodo(I, P), periodos_capitalizables(P, n2)) << endl;
